# Generated by Django 3.2.18 on 2023-02-19 15:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('AZ', 'Arizona'), ('CA', 'California'), ('FL', 'Florida'), ('GA', 'Georgia'), ('MA', 'Massachusetts'), ('MI', 'Michigan'), ('NY', 'New York'), ('TX', 'Texas'), ('VA', 'Virginia'), ('WA', 'Washington')], max_length=100)),
                ...
                ('milage', models.IntegerField(max_length=255)),
